          ...
          <div className="col-lg-6">
            <div className="left-block mt-100 md-mb50">
              <div className="d-flex align-items-center">
                <div>
                  <div className="info">
                    <h3 className=" main-color fz-50 line-height-1">8</h3>
                    <p className="nowrap">
                      Years of
                      <br /> Experience
                    </p>
                ...
                <div>
                  <div className="img fit-img radius-30">
                    <img
                      src="/dark/assets/imgs/intro/freelancer.JPG"
                      alt=""
                    />
                  </div>
                </div>
          ...
          <div className="col-lg-6 valign">
            <div className="content full-width">
              <div className="sec-head mb-30">
                ...
                <h2>
                  WordPress Solutions <br /> Architect.
                </h2>
                <div className="text mt-15">
                  <p>
                    As a WordPress Solutions Architect, I leverage innovative design and technical expertise to create user-centric websites that drive engagement and enhance accessibility, ensuring our digital solutions make a meaningful impact.
                  </p>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="d-flex align-items-center mb-20">
                      ...
                      <div className="ml-20">
                        <p className="fz-14">Mehedi Hasan Azim</p>
                      </div>
                    </div>
                    <div className="d-flex align-items-center">
                      <div>
                      ...
                      <div className="ml-20">
                        <p className="fz-14">Gopalganj Office Bangladesh</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="d-flex align-items-center mb-20">
                      ...
                      <div className="ml-20">
                      <a href="https://wa.me/+8801675924106" target='blank'><p className="fz-14">+1 675 924 106</p></a>
                      </div>
                    </div>
                    <div className="d-flex align-items-center">
                      <div>
                      ...
                      <div className="ml-20">
                      <a href="mailto:mehedi4106@gmail.com" target='blank'><p className="fz-14">mehedi4106@gmail.com</p></a>
                      </div>
                    </div>
                  </div>
                </div>
